...
public class GameBoardFull extends GameBoard {
    public GameBoardFull() {
        ...
        IOwnableCell cc1 = new CardCell(Card.TYPE_CC, "Community Chest 1");
        ...
        IOwnableCell c1 = new CardCell(Card.TYPE_CHANCE, "Chance 1");
        ...
        IOwnableCell cc2 = new CardCell(Card.TYPE_CC, "Community Chest 2");
        ...
        IOwnableCell c2 = new CardCell(Card.TYPE_CHANCE, "Chance 2");
        ...
        IOwnableCell cc3 = new CardCell(Card.TYPE_CC, "Community Chest 3");
        PropertyCell g3 = new PropertyCell();
        RailRoadCell rr4 = new RailRoadCell();
        IOwnableCell c3 = new CardCell(Card.TYPE_CHANCE, "Chance 3");
